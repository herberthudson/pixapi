...
public class Validators {
    ...
    private static @NotNull String removeCaracteresEspeciais(String doc) {
        if (doc.contains(".")) {
            doc = doc.replace(".", "");
        }
        if (doc.contains("-")) {
    ...
    public static boolean isEmail(String email){
        ...
        String emailRegexPattner = "^[a-zA-Z0-9_!#$%&'*+/=?`{|}~^.-]+@[a-zA-Z0-9.-]+$";
        return Pattern.compile(emailRegexPattner).matcher(email).matches();
    }
